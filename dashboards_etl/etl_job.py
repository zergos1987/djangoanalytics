...
def job(
	...
	if ETL_IS_ACTUAL:
		...
		if TABLE_NAME_PREFIX != '-' and TABLE_NAME_PREFIX is not None: 
		...
		if WHERE_CONDITION_FROM == '-' and WHERE_CONDITION_FROM is None: WHERE_CONDITION_FROM = 'and 2=2'
		if WHERE_CONDITION_TO == '-' and WHERE_CONDITION_TO is None: WHERE_CONDITION_TO = 'and 2=2'
