...
#@method_decorator([login_required, permission_required("database_sqlite_test.can_view_app")], name="dispatch")
@login_required
@permission_required('database_sqlite_test.can_view_app')
def index(request):
