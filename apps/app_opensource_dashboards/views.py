...
#@method_decorator([login_required, permission_required("app_opensource_dashboards.can_view_app")], name="dispatch")
@login_required
@permission_required('app_opensource_dashboards.can_view_app')
def index(request):
