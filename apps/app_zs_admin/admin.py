...
class aside_left_menu_includesResource(resources.ModelResource):
    class Meta:
        ...
        fields = (
            'name',  'menu_level', 'menu_icon_type', 'render_app_name',  'parent_name_order_by', 'name_order_by',  'is_actual',  'href',  ) 

class aside_left_menu_includesAdmin(ImportExportModelAdmin):
    list_display = [
        'id', 'parent_name_short', 'name',  'menu_level', 'menu_icon_type', 'render_app_name',  'parent_name_order_by', 'name_order_by',  'is_actual',  'href']
