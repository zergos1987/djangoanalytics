# Generated by Django 3.2.6 on 2021-10-01 17:21
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('app_zs_admin', '0010_alter_notification_events_event_content'),
    ]

    operations = [
        migrations.CreateModel(
            name='etl_job_database_tables_tasks',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('limit_rows', models.IntegerField(default=30000, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(100000)])),
                ('database_name_from', models.CharField(choices=[('khd', 'khd'), ('sadko', 'sadko'), ('djangoanalytics', 'djangoanalytics')], max_length=200)),
                ('database_name_to', models.CharField(choices=[('khd', 'khd'), ('sadko', 'sadko'), ('djangoanalytics', 'djangoanalytics')], max_length=200)),
                ('table_schema_from', models.CharField(choices=[('dak', 'dak'), ('djangoanalytics', 'djangoanalytics'), ('djangoanalytics_dashboards', 'djangoanalytics_dashboards')], max_length=200)),
                ('table_schema_to', models.CharField(choices=[('dak', 'dak'), ('djangoanalytics', 'djangoanalytics'), ('djangoanalytics_dashboards', 'djangoanalytics_dashboards')], max_length=200)),
                ('table_name_prefix', models.CharField(blank=True, default='xxx', max_length=200, null=True)),
                ('table_name_from', models.CharField(max_length=300)),
                ...
                ('columns_from', models.TextField(default='*')),
                ('columns_for_unique_id', models.TextField(default='*')),
                ...
                ('steps_delay_seconds', models.IntegerField(default=5, validators=[django.core.validators.MinValueValidator(2), django.core.validators.MaxValueValidator(30)])),
                ('created_date', models.DateTimeField(auto_now_add=True)),
                ('updated_date', models.DateTimeField(auto_now=True)),
                ('etl_error_flag', models.BooleanField(default=False)),
                ('is_actual', models.BooleanField(default=False)),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='for_etl_job_database_tables_tasks_created_by', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('update_week_days_list', models.CharField(choices=[('monday', 'monday'), ('tuesday', 'tuesday'), ('wednesday', 'wednesday'), ('thursday', 'thursday'), ('friday', 'friday')], max_length=70)),
        ...
        migrations.CreateModel(
            name='etl_job_database_tables_tasks_logs',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('table_rows_count', models.IntegerField(default=0, validators=[django.core.validators.MinValueValidator(0)])),
                ('error_message', models.TextField(blank=True, default='', null=True)),
                ('updated_at', models.DateTimeField(auto_now_add=True)),
                ('etl_job_database_tables_tasks_fk', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='for_etl_job_database_tables_tasks_logs', to='app_zs_admin.etl_job_database_tables_tasks')),
            ],
            options={
                'ordering': ('-updated_at',),
            },
        ...
        migrations.AddField(
            model_name='etl_job_database_tables_tasks',
            name='update_time_list',
            field=models.ManyToManyField(blank=True, limit_choices_to={'is_actual': True}, to='app_zs_admin.time_intervals'),
        ),
        migrations.AddField(
            model_name='etl_job_database_tables_tasks',
            name='update_week_days_list',
            field=models.ManyToManyField(blank=True, limit_choices_to={'is_actual': True}, to='app_zs_admin.week_intervals'),
        ),
        migrations.AddField(
            model_name='etl_job_database_tables_tasks',
            name='updated_by',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='for_etl_job_database_tables_tasks_updated_by', to=settings.AUTH_USER_MODEL),
        ),
    ]
